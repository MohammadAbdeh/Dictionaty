...
public class ServiceAgent extends Agent {
	protected void setup () {
		...
		addBehaviour(new GeneralCyclicBehaviour(this));
...
class GeneralCyclicBehaviour extends CyclicBehaviour
{
	ServiceAgent agent;
	public GeneralCyclicBehaviour(ServiceAgent agent)
	{
		this.agent = agent;
	}
	public void action()
...
class HomeworkDictCyclicBehaviour extends CyclicBehaviour
{
	ServiceAgent agent;
	public HomeworkDictCyclicBehaviour(ServiceAgent agent)
	{
		this.agent = agent;
	}
	public void action()
	{
		MessageTemplate template = MessageTemplate.MatchOntology("dict");
		ACLMessage message = agent.receive(template);
		if (message == null)
		{
			block();
