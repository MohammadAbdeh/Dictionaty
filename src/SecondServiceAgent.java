...
public class SecondServiceAgent extends Agent {
	protected void setup () {
		...
		addBehaviour(new TheElementsCyclicBehaviour(this));
...
class TheElementsCyclicBehaviour extends CyclicBehaviour
{
	SecondServiceAgent agent;
	public TheElementsCyclicBehaviour(SecondServiceAgent agent)
	{
		this.agent = agent;
	}
	public void action()
	{
		MessageTemplate template = MessageTemplate.MatchOntology("elements");
